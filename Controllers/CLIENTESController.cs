...
namespace PostoInformatica_ERP.Controllers
{
    public class CLIENTESController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CNPJ_CPF,RG_INSCRICAO,INSCRICAOMUNICIPAL,NOME,FANTASIA,COLIGADA,CEP,ENDERECO,ENDERECO_COBRANCA,NUMERO,NUMERO_COBRANCA,COMPLEMENTO,COMPLEMENTO_COBRANCA,BAIRRO,BAIRRO_COBRANCA,CIDADE,CIDADE_COBRANCA,CIDADE_IBGE,ESTADO,ESTADO_COBRANCA,CAIXA_POSTAL,CAIXA_POSTAL_COBRANCA,PAIS,FONE,FONE_RAMAL,CELULAR,INTERNET,CONTATO,EMAIL,COND_PAGAMENTO,CODIGO,LOGIN,SENHA")] CLIENTES cLIENTES)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CNPJ_CPF,RG_INSCRICAO,INSCRICAOMUNICIPAL,NOME,FANTASIA,COLIGADA,CEP,ENDERECO,ENDERECO_COBRANCA,NUMERO,NUMERO_COBRANCA,COMPLEMENTO,COMPLEMENTO_COBRANCA,BAIRRO,BAIRRO_COBRANCA,CIDADE,CIDADE_COBRANCA,CIDADE_IBGE,ESTADO,ESTADO_COBRANCA,CAIXA_POSTAL,CAIXA_POSTAL_COBRANCA,PAIS,FONE,FONE_RAMAL,CELULAR,INTERNET,CONTATO,EMAIL,COND_PAGAMENTO,CODIGO,LOGIN,SENHA")] CLIENTES cLIENTES)
        {
